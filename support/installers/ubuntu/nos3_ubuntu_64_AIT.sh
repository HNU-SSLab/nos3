...
cp /home1/ncloud/nos3/support/installers/common/nos3_99-firstboot.sh /home/$NOS3_USER/99-firstboot.sh 
...
cp /home1/ncloud/nos3/support/installers/centos/rc.local /etc/rc.local
...
echo "Setup rc.local..."
cp /home1/ncloud/nos3/support/installers/ubuntu/rc.local /etc/rc.local
dos2unix -q /etc/rc.local

echo "Setup Postactivate..."
cp /home1/ncloud/nos3/support/installers/ubuntu/postactivate /home/$NOS3_USER/
